...
public class WeatherWidget extends AppWidgetProvider {
    ...
    public static RemoteViews updateRemoteViews(Context context) {
        ...
        if (null == todayWeather) {
            ...
            view.setTextViewText(R.id.cloud,day.getFengxiang());
            view.setTextViewText(R.id.cur_temp,todayWeather.getQuality());
            view.setTextViewText(R.id.low_temp, day.getLow());
            view.setTextViewText(R.id.high_temp, day.getHigh());
            return view;
        }
    }
    @Override
